...
Runs pydoclint over the worker (the ``vgi_scikit_bio`` package plus the two
...
documented arguments, return values, and dataclass attributes actually match the
...
_TARGETS = ["vgi_scikit_bio/", "scikit_bio_worker.py", "serve.py"]
